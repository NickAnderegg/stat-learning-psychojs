import { MonotonicClock, Clock } from './util-2021.1.0.js';
import { Scheduler } from './util-2021.1.0.js';
import { PsychObject } from './util-2021.1.0.js';
import { getRequestError, toString, getUrlParameters, detectBrowser, to_win } from './util-2021.1.0.js';
import { ExperimentHandler } from './data-2021.1.0.js';
import { MonotonicClock as MonotonicClock$1, PsychObject as PsychObject$1, Color } from './util-2021.1.0.js';
import { ExperimentHandler as ExperimentHandler$1 } from './data-2021.1.0.js';
...
class Logger
{
	...
	log(msg, level, time, obj)
	{
		...
		{
			time = MonotonicClock$1.getReferenceTime();
		}
			...
			if (time - timeAtStartThrottlingWindow < this._throttling.window)
			{
				if (!this._throttling.isThrottling)
				{
					...
					if (!this._throttling.designerWasWarned &&
						(this._psychoJS.getEnvironment() === ExperimentHandler$1.Environment.LOCAL ||
	...
	async flush()
	{
		...
		if (this._psychoJS.getEnvironment() === ExperimentHandler$1.Environment.SERVER &&
